-- Система ежедневных отметок с календарем и стрейками (ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
-- 5. Функция для выполнения ежедневной отметки (ИСПРАВЛЕННАЯ)
...
-- 6. Функция для получения календаря отметок пользователя (ИСПРАВЛЕННАЯ)
...
-- 7. Функция для проверки, можно ли отметиться сегодня (ИСПРАВЛЕННАЯ)
