...
import { getCategoryById, updateCategory, uploadCategoryImage, Category } from '@/lib/supabase'
...
export default function EditCategoryPage({ params }: EditCategoryPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedFile) {
        const { data: imageUrl, error: uploadError } = await uploadCategoryImage(selectedFile, params.id)
      ...
      const { error } = await updateCategory(params.id, updateData)
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Загрузка категории...</p>
        </div>
      </div>
    )
  }
